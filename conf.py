...
project = u'Runestone Interactive' # e.g. How To Think Like a Computer Scientist
copyright = u'2014 Brad Miller and David Ranum' # e.g. "2013, Brad Miller and David Ranum"
...
html_theme_options = {
    ...
    'navbar_title': "Learning At Scale 2014",
...
html_title = 'Learning At Scale'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Learning At Scale'
